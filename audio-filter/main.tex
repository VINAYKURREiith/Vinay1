...
\begin{align}
	&y(n) - \brak{2.30}y(n - 1) + \brak{2.21}y(n - 2) \nonumber \\
	&- \brak{0.992}y(n - 3) + \brak{0.174}y(n - 4) \nonumber \\
	&= \brak{5.54\times 10^{-3}}x(n) + \brak{2.22 \times 10^{-2}}x(n - 1) \nonumber \\
	&+ \brak{3.33 \times 10^{-2}}x(n - 2) + \brak{2.22 \times 10^{-2}}x(n - 3) \nonumber \\
	&+ \brak{5.54 \times 10^{-3}}x(n - 4)
\end{align}
