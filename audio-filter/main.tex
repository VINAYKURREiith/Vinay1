...
Run the following commands(for laptop)
\begin{lstlisting}
sudo apt-get update
sudo apt-get install libffi-dev libsndfile1 python3-scipy  python3-numpy python3-matplotlib 
sudo pip install cffi pysoundfile 
\end{lstlisting}
Run the following commands(for termex(mobile))
\begin{lstlisting}
apt-get update
...
There are a lot of yellow lines between 440 Hz to 5KHz.  These represent the synthesizer key tones. Also, the key strokes
