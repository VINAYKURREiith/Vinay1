...
\end{align}
Substituting respective values in \eqref{eq:Gain_eq_LP} we get $G_{LP}=1.9552$
\begin{align}
     H_{a,LP}(s_L) &= \frac{2.707}{\brak{s_L-s_1}\brak{s_L-s_2}\brak{s_L-s_3}\brak{s_L-s_4}}\\
     &= \frac{1.9552}{s_{L}^4 + 1.9094s_L^3 + 4.0058s_L^2 + 3.7139s_L + 2.04632}\label{eq:design}
\end{align}
\begin{lstlisting}
https://github.com/VINAYKURREiith/Vinay1/blob/master/filter-design/codes/fig3.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{align}
    H_{a,BP}\brak{s} &= \frac{1.5265 \times 10^{-4}s^4}{s^8 + 0.1795s^7 + 0.8112s^6 + 0.1075s^5 + 0.2396s^4 + 0.0209s^3 + 0.03052s^2 + 0.00131s + 0.00142} \label{eq:magnitude_bandpass_sdom}
\end{align}
...
\begin{lstlisting}
https://github.com/VINAYKURREiith/Vinay1/blob/master/filter-design/codes/fig4.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
where $G=1.5265 \times 10^{-4}$\\  
\begin{lstlisting}
https://github.com/VINAYKURREiith/Vinay1/blob/master/filter-design/codes/fig5.py
\end{lstlisting}  
\begin{figure}[H]
\centering
...
\end{align}
\begin{lstlisting}
https://github.com/VINAYKURREiith/Vinay1/blob/master/filter-design/codes/fig6.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\end{enumerate}
\begin{lstlisting}
https://github.com/VINAYKURREiith/Vinay1/blob/master/filter-design/codes/fig7.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\end{align}
\begin{lstlisting}
https://github.com/VINAYKURREiith/Vinay1/blob/master/filter-design/codes/fig8.py
\end{lstlisting}
\begin{figure}[H]
\centering
