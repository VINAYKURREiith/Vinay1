...
# Given parameters
epsilons = [0.3043, 0.45, 0.55, 0.6197]
...
plt.legend(loc='best', title='Passband and Stopband', labels=['Epsilon = 0.3043', 'Epsilon = 0.45', 'Epsilon = 0.55', 'Epsilon = 0.6197', 'Passband', 'Stopband'])
plt.grid(True)
